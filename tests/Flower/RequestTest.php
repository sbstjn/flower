...
class RequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testParseFromEnvironment()
    {
        ...
        $this->assertInstanceOf('\Flower\Request', $Request);
    ...
    {
        $req = new \Flower\Request('http://example.com/lorem?fancy=shit&lorem=ipsum+1', 'GET');
    ...
    {
        $req = new \Flower\Request('http://example.com/lorem-ipsum/dolor/sit?fancy=shit&lorem=ipsum+1', 'GET');
        $route = new \Flower\Route('GET', '/:route/:test/:amet', function () {
